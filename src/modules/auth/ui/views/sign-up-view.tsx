  ...
  return (
    <div className="relative min-h-screen h-screen w-full overflow-hidden flex items-center justify-center p-4 bg-black">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute -left-20 -top-28 w-96 h-96 rounded-full bg-gradient-to-tr from-emerald-400/20 via-green-300/10 to-transparent blur-3xl animate-blob" />
        <div className="absolute right-0 bottom-10 w-80 h-80 rounded-full bg-gradient-to-bl from-green-600/18 via-emerald-500/8 to-transparent blur-3xl animate-blob animation-delay-1500" />
      </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <span className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <span
                          className="absolute left-[-40%] top-0 w-[140%] h-full transform -skew-x-12 translate-x-[-60%] group-hover:translate-x-[10%] transition-transform duration-700 bg-[linear-gradient(90deg,#FF9AA2,#FFE29A,#B6FFCE,rgba(255,255,255,0))]"
                          style={{ mixBlendMode: "screen" }}
                        />
                      </span>
                    </button>
                    ...
                    >
                      ...
                      <span className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <span
                          className="absolute left-[-40%] top-0 w-[140%] h-full transform -skew-x-12 translate-x-[-60%] group-hover:translate-x-[10%] transition-transform duration-700 bg-[linear-gradient(90deg,#A8B3FF,#7CF7D5,#B6FFCE,rgba(255,255,255,0))]"
                          style={{ mixBlendMode: "screen" }}
                        />
                      </span>
                    </button>
