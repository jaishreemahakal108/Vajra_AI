...
import { Plus, Users, XCircle, Sparkles } from "lucide-react";
    ...
    return (
        <>
            ...
            <div className="py-6 px-4 md:px-8 flex flex-col gap-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h5 className="relative font-bold text-2xl bg-gradient-to-r from-amber-600 via-orange-600 to-amber-600 bg-clip-text text-transparent animate-pulse">
                                    My Meetings
                                    <Sparkles className="inline-block w-5 h-5 ml-2 text-amber-500 animate-pulse" />
                                </h5>
                            </div>
                ...
                {/* Filters in single line - centered and compact with 3D effect */}
                <div className="flex justify-center perspective-1000">
                    <div className="relative group">
                        ...
                        <div className="relative bg-white/60 backdrop-blur-md rounded-xl shadow-lg shadow-amber-500/5 border border-amber-200/40 p-3 hover:shadow-xl hover:shadow-amber-500/10 hover:-translate-y-1 transition-all duration-300 inline-flex">
                            <div className="flex items-center gap-2">
                                ...
                                {/* Status with glow */}
                                <div className="hover:shadow-lg hover:shadow-amber-500/30 rounded-lg transition-all duration-300 hover:-translate-y-0.5 hover:scale-105">
                                    <StatusFilter />
                                </div>
                                ...
                                {/* Clear button with red glow and shake effect */}
                                {isAnyFilterModified && (
                                    <Button 
                                        variant="outline" 
                                        onClick={onClearFilters}
                                        className="relative border-red-300/50 text-red-600 hover:bg-red-50 hover:text-red-700 hover:border-red-400 hover:shadow-lg hover:shadow-red-500/40 transition-all duration-200 gap-2 hover:-translate-y-0.5 hover:scale-105 group overflow-hidden"
                                    >
