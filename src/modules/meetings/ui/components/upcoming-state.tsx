...
//             />
//             <div className="flex flex-col-reverse lg:flex-row lg:justify-center items-center gap-20 w-full">
//                 <div className="w-full lg:w-auto bounce-button">
//                     <Button
//                         variant="secondary"
//                         className="w-full lg:w-auto relative overflow-visible
//                                    before:absolute before:inset-0 before:rounded-md before:bg-red-500 
//                                    before:opacity-40 before:blur-md before:animate-pulse-glow
//                                    hover:before:opacity-70 hover:before:blur-lg hover:before:scale-110
...
//                         disabled={isCancelling}
//                         asChild 
//                         className="w-full lg:w-auto relative overflow-visible bg-green-700 hover:bg-green-800 text-white
//                                    before:absolute before:inset-0 before:rounded-md before:bg-green-500 
//                                    before:opacity-40 before:blur-md before:animate-pulse-glow
//                                    hover:before:opacity-70 hover:before:blur-lg hover:before:scale-110
//                                    hover:scale-105 transition-all duration-300"
//                     >
